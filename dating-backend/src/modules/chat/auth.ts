...
export const authMiddleware = async (
  ...
  try {
    const decoded = jwt.verify(token, process.env.JWT_SECRET!) as { userId: string; email: string; role: string; iat: number; exp: number; name: string; genderPreference: string; };
